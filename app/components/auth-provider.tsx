...
interface AuthContextValue { user: User | null; isAuthenticated: boolean }
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return <AuthContext.Provider value={{ user, isAuthenticated: state === 'authenticated' }}>{children}</AuthContext.Provider>
}